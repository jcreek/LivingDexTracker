	...
	<div class="text-center py-16" data-testid="no-pokedexes-message">
		<div class="max-w-md mx-auto">
			...
			<p class="text-base-content/70 mb-8">
				Create your first Pokédex to start tracking your collection. Choose from National, Regional,
				or create a custom tracker for your specific goals.
			</p>
			<a
				href="/pokedexes/create"
				class="btn btn-primary btn-lg"
				data-testid="create-first-pokedex-button"
			>
			...
			>
				<div class="card-body">
					<div class="flex items-start justify-between">
						...
						<div class="dropdown dropdown-end">
							<div
								...
								data-testid="pokedex-menu-button"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
							...
							<ul
								...
								data-testid="pokedex-menu"
							>
								<li>
									<a href="/mydex?id={pokedex.id}" data-testid="view-pokedex-link">View Pokédex</a>
								</li>
								<li>
									<a href="/pokedexes/{pokedex.id}/edit" data-testid="edit-pokedex-link"
										>Edit Settings</a
									>
								</li>
								<li>
									<button
										class="text-error"
										on:click={() => deletePokedex(pokedex.id, pokedex.name)}
										data-testid="delete-pokedex-button"
									>
										Delete
									</button>
								</li>
						...
						<div class="mb-4">
							<div class="flex items-center justify-between text-sm mb-2">
								...
								<span class="font-semibold"
									>{stats.caught}/{stats.total} ({stats.percentComplete}%)</span
								>
							</div>
							<div class="progress progress-success h-2">
								<div class="progress-bar bg-success" style="width: {stats.percentComplete}%"></div>
							</div>
						</div>
					...
					<div class="card-actions justify-between mt-4">
						...
						<a
							href="/mydex?id={pokedex.id}"
							class="btn btn-primary btn-sm"
							data-testid="open-pokedex-button"
						>
							Open
						</a>
					</div>
